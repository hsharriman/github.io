        ...
        <div id="about-section">
          <div className="subtitle" style={{ color: "var(--blue)" }}>
            <img
              ...
              src="assets/img/cursors/pt2.gif"
              alt=""
            />{" "}
          ...
          <div id="about-intro">
            <div id="about-img">
              <img src="assets/img/self_portrait.gif" alt="headshot" />
            </div>
            <p>
              I am a first-year PhD student in software engineering at Carnegie
              Mellon University, advised by Josh Sunshine and Dominik Moritz. My
              experience is primarily in full stack engineering, data analysis
              ...
              looking for interesting ways that technology and design intersect,
              and I care about working on impactful projects that have the power
              to make the world a better place.
            </p>
            <p className="mobilehide">
              Check out my <a href="assets/img/resumesummer2022.pdf">resume</a>{" "}
              for more detailed descriptions of my professional experience and
              ...
              <div className="about-bullet">
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      Research Intern at
                      <a href="http://penrose.ink/">Penrose</a> (Carnegie Mellon
                      University),
              ...
              <div className="about-bullet">
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      1st Place Undergraduate Division, ACM SPLASH Student
            ...
            <div className="about-text">
              <div className="about-bullet">
                <div>
                  ...
                  <ul>
                    <li>Professional ballerina, guests around U.S</li>
                    <li>Digital Illustrator, owner of Arken Designs</li>
  ...
  return (
    <div>
      ...
      <div className="icon" onclick="window.location.href='#landing-pg'">
        <img src="assets/img/cursors/loading.gif" alt="" />
      </div>
      <div id="shadow"></div>
        ...
        <div id="landing-pg">
          ...
          <div className="circle-container">
            ...
            >
              <img
                className="large-pt"
                src="assets/img/cursors/pt2pink.gif"
                alt=""
              />
            ...
            >
              <img
                className="large-pt"
                src="assets/img/cursors/pt2mint.gif"
                alt=""
              />
              &nbsp;Design Projects
            </div>
            ...
            <div
              ...
              onclick="window.open('assets/img/resumesummer2022.pdf')"
            >
              <img
                className="small-pt"
                src="assets/img/cursors/pt2purple.gif"
                alt=""
              />
              &nbsp;Resume
            </div>
            ...
            >
              <img
                className="large-pt"
                src="assets/img/cursors/pt2red.gif"
                alt=""
              />
              ...
              <ul id="other">
                <li onclick="window.location.href='research/edgeworth.html'">
                  ...
                  <div className="tools">
                    ...
                    <br />
                    ACM SPLASH Student Research Competition
                    <br />
                    2021
                  </div>
                  <div className="thumb">
                    <img src="assets/img/research/edgeworththumb.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='research/clew3d.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/research/clew3dthumb.png" alt="" />
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="columns">
            <div className="software">
              <div className="subtitle" style={{ color: "var(--pink)" }}>
                ...
                />
                Software Projects
                <span className="dash" style={{ color: "var(--pink)" }}>
                  ----------
                </span>
              </div>
              <ul>
                <li onclick="window.location.href='engr/swiss.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/generator.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='engr/lda.html'" id="lda">
                  ...
                  <div className="thumb">
                    <img src="assets/img/software/lda/ldathumb.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='engr/mnist.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/cnnfull.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='engr/robolympics.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/pid.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='engr/ransac.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/ransac.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='engr/faces.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/facesdark.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='engr/paletteful.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/software/paletteful/crop.gif" alt="" />
                  </div>
                </li>
              </ul>
            </div>
            <div className="list-section">
              <div className="subtitle-container">
                <div className="subtitle">
                  ...
                  />
                  Design Projects
                  <span className="dash" style={{ color: "var(--mint)" }}>
                    -----------
                  </span>
                </div>
              </div>
              <ul>
                <li onclick="window.location.href='design/starcycle.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/design/star/starsmall.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='design/yagp.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/design/yagp/yagpthumb.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='design/moma.html'">
                  ...
                  <div className="thumb">
                    <img
                      src="assets/img/design/nerioxman/nerioxman2-04thumb.png"
                      alt=""
                    />
                  </div>
                </li>
                <li onclick="window.location.href='design/disney.html'">
                  ...
                  <div className="thumb">
                    <img
                      src="assets/img/design/disney/disneythumb.png"
                      alt=""
                    />
                  </div>
                </li>
                <li onclick="window.location.href='design/ballet.html'">
                  ...
                  <div className="thumb">
                    <img
                      src="assets/img/design/ballet/balletfeltronthumb.png"
                      alt=""
                    />
                  </div>
                </li>
            ...
            <div className="other-section">
              ...
              <div className="subtitle-container">
                <div className="subtitle" style={{ color: "var(--purple)" }}>
                  ...
                  />
                  Other Projects
                  <span className="dash" style={{ color: "var(--purple)" }}>
                    -----------
                  </span>
                </div>
              </div>
              <ul id="other">
                <li onclick="window.location.href='other_proj/illustration.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/illustration/12thumb.png" alt="" />
                  </div>
                </li>
                <li onclick="window.location.href='other_proj/spaceman.html'">
                  ...
                  <div className="thumb">
                    <img src="assets/img/design/spacemanthumb.png" alt="" />
                  </div>
                </li>
              </ul>
            </div>
