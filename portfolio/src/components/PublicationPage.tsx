...
export class PublicationPage extends React.Component<PublicationProps> {
  ...
  render() {
    const subheaderCss = "text-xl font-ibmMono text-themePurpleLight";
    const authors = this.props.authors.map((author, idx) => (
      <span
        className={`font-notoSans whitespace-nowrap text-themePink text-xl ${
    ...
    return (
      <div className={backgroundCSS}>
        ...
        <div className={"pt-24 pb-8 w-screen flex h-full justify-center"}>
          <div className={pageMarginCSS + "max-w-screen-md"}>
            ...
            <div className=" text-themeMint text-lg flex flex-row flex-wrap break-words">
              {this.props.award &&
